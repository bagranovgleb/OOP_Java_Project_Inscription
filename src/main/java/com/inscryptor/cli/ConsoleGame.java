package com.inscryptor.cli;

import com.inscryptor.ai.OpponentAI;
import com.inscryptor.ai.SimpleOpponentAI;
...
public class ConsoleGame {
    ...
    public void run() {
        System.out.println("=== Inscryptor: card battler prototype ===");
        printHelp();
